    ...
    <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
      ...
      <div>
        ...
        <input
          ...
          value={formData.previous_employment?.employer_city || ''}
          onChange={e => handleNestedInputChange(['previous_employment', 'employer_city'], e.target.value)}
          className="bg-white flex h-10 w-full rounded-md border border-input px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm"
          readOnly={isReadOnly}
          placeholder="City"
        />
      ...
      <div>
        ...
        <select
          ...
          value={formData.previous_employment?.employer_state || ''}
          onChange={e => handleNestedInputChange(['previous_employment', 'employer_state'], e.target.value)}
          className="bg-white flex h-10 w-full rounded-md border border-input px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm"
          disabled={isReadOnly}
        >
      ...
      <div>
        ...
        <input
          ...
          value={formData.previous_employment?.employer_zip_code || ''}
          onChange={e => {
            const val = e.target.value;
            if (/^\d{0,5}$/.test(val)) handleNestedInputChange(['previous_employment', 'employer_zip_code'], val);
          }}
          className="bg-white flex h-10 w-full rounded-md border border-input px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm"
          readOnly={isReadOnly}
